...
import 'package:hunter/views/HomeView/web_view_container.dart';
import 'package:hunter/views/Other/OtherView.dart';
                ...
                return index == categList.length
                    ? GestureDetector(
                        onTap: () {
                          Navigator.pushReplacement(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => HomeView(header: "5")));
                        },
                        child: Container(
                    ...
                    : c.get('title') != null && c.get('img') != null
                        ? GestureDetector(
                            ...
                            child:
                                _mainItem1('${c.get('title')}', c.get('img')))
                        : Container();
              }),
        ),
